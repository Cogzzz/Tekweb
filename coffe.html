...
<body>  
    <header>
        ...
        <div class="header-actions">
            <a id="login" href="user/loginpage.html">Regist Now</a>
            <div class="header-icon">
                ...
                <div class="dropdown">
                    ...
                    <div class="dropdown-menu" id="dropdown-menu">
                        <a href="profile_user/profileuser.html" class="dropdown-item">Profile User</a>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="text-center">
                                <a href="checkout/checkout.html" class="btn btn-primary w-100 mb-2">Checkout</a>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <section class="home" id="home">
        <div class="home-text">
            ...
            <p> Nikmati hari Anda dengan secangkir kopi terbaik yang kami tawarkan. Dari biji kopi pilihan hingga racikan penuh cinta, temukan kenikmatan sempurna di setiap tegukan. Jadikan setiap pagi lebih bersemangat bersama kami!</p>
    ...
    <section class="about" id="about">
        ...
        <div class="about-text">
            <h2>Our History</h2>
            <p>Kami memulai perjalanan kami dengan visi untuk menghadirkan kopi berkualitas terbaik kepada setiap pecinta kopi. Berawal dari kecintaan pada rasa dan aroma kopi, kami tumbuh menjadi sebuah komunitas yang menjunjung tinggi nilai tradisi dan inovasi.</p>
            <p>Setiap biji kopi yang kami pilih bercerita tentang perjalanan panjang dari petani lokal hingga menjadi secangkir kopi istimewa. Kami bangga mendukung petani kopi lokal, menjaga keberlanjutan, dan menyajikan kopi dengan cinta dan keahlian.</p>
            <p>Bergabunglah dengan kami untuk menjelajahi dunia kopi yang penuh dengan cerita, rasa, dan pengalaman tak terlupakan.</p>
    ...
    <section class="product" id="menu">
        ...
        <div class="products-container">
            <!-- Product 1 -->
            <div class="box" data-category="Strong" data-name="Americano">
                <img src="asset/p1.png" alt="">
                <h3>Americano</h3>
                <div class="content">   
                    <span>Rp.25.000</span>
                    <button class="add-to-cart" data-name="Product 1" data-price="25000" data-img="asset/p1.png">Add To Cart</button>
                </div>
            </div>
    
            <!-- Product 2 -->
            <div class="box" data-category="Light" data-name="Latte">
                <img src="asset/p2.png" alt="">
                <h3>Latte</h3>
                <div class="content">
                    <span>Rp.25.000</span>
                    <button class="add-to-cart" data-name="Product 2" data-price="25000" data-img="asset/p2.png">Add To Cart</button>
                </div>
            </div>
    
            <!-- Product 3 -->
            <div class="box" data-category="Strong" data-name="Espresso">
                <img src="asset/p3.png" alt="">
                <h3>Espresso</h3>
                <div class="content">
                    <span>Rp.25.000</span>
                    <button class="add-to-cart" data-name="Product 3" data-price="25000" data-img="asset/p3.png">Add To Cart</button>
                </div>
            </div>
    
            <!-- Product 4 -->
            <div class="box" data-category="Mild" data-name="Picollo">
                <img src="asset/p4.png" alt="">
                <h3>Picollo</h3>
                <div class="content">
                    <span>Rp.25.000</span>
                    <button class="add-to-cart" data-name="Product 4" data-price="25000" data-img="asset/p4.png">Add To Cart</button>
                </div>
            </div>
    
            <!-- Product 5 -->
            <div class="box" data-category="Mild" data-name="Cold Brew">
                <img src="asset/p5.png" alt="">
                <h3>Cold Brew</h3>
                <div class="content">
                    <span>Rp.25.000</span>
                    <button class="add-to-cart" data-name="Product 5" data-price="25000" data-img="asset/p5.png">Add To Cart</button>
                </div>
            </div>
    
            <!-- Product 6 -->
            <div class="box" data-category="Strong" data-name="Long Black">
                <img src="asset/p6.png" alt="">
                <h3>Long Black</h3>
                <div class="content">
                    <span>Rp.25.000</span>
                    <button class="add-to-cart" data-name="Product 6" data-price="25000" data-img="asset/p6.png">Add To Cart</button>
                </div>
            </div>
        </div>
